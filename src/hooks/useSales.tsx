...
export const useSales = () => {
        ...
        const orderItems = itemsData
          ...
          .map(item => {
            const product: InventoryItem = {
              ...
              unitOfMeasure: item.product.unit_of_measure as UnitOfMeasure,
              purchaseCost: item.product.purchase_cost,
  ...
  const addSalesOrder = async (orderData: CreateSalesOrderParams) => {
    try {
      ...
      const orderNumber = `SO-${yearMonth}${randomNum}`;
      ...
      const customerIdValue = orderData.customerId === 'walk-in' || !orderData.customerId 
        ? null 
