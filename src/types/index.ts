...
export type AdjustmentReason = 'damage' | 'counting_error' | 'return' | 'theft' | 'other' | 'sale' | 'purchase';
...
// Sales types
export type SalesOrderStatus = 'draft' | 'pending' | 'confirmed' | 'processing' | 'shipped' | 'delivered' | 'completed' | 'cancelled';
